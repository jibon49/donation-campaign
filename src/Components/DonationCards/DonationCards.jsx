...
const DonationCards = ({ card }) => {
    ...
    return (
        <div className="card card-side bg-base-100 shadow-xl" style={{backgroundColor:card_bg}}>
            <figure className=" w-56"><img className="lg:h-52 md:h-64 h-60" src={picture} /></figure>
            <div className="card-body">
                ...
                <Link to={`/details/${id}`}><button className="px-4 py-2 md:w-1/2 rounded-lg" style={{ backgroundColor: text_color, color: "white", border: 0}}>View Details</button></Link>
